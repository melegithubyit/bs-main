...
export default function ApplicantCard({ applicant, index, layout }: ApplicantCardProps) {
            ...
            >
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-gray-500 line-clamp-1">{applicant.description}</p>
                        ...
                        <div className="mt-2">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-xs text-gray-500">{applicant.fundingProgress || 0}%</span>
                            </div>
    ...
    return (
        ...
        >
            ...
            <div className="mb-3">
                <p className="text-sm text-gray-600 line-clamp-2">{applicant.description}</p>
            </div>
            ...
            <div className="mb-4">
                <div className="flex items-center justify-between mb-1">
                    <span className="text-sm font-medium">ETB {Number.parseInt(applicant.goalFund).toLocaleString()}</span>
                    <span className="text-xs text-gray-500">{applicant.fundingProgress || 0}% funded</span>
                </div>
                ...
                <div className="flex items-center gap-1 mt-2">
                    ...
                    <span className="text-xs text-gray-500">{applicant.supporters || 0} supporters</span>
                </div>
            </div>
            <Button
                variant="outline"
