...
export default function ProjectCard({ project, index, layout }: ProjectCardProps) {
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500 line-clamp-1">{project.projectDescription}</p>
        ...
        <div className="flex flex-col items-end gap-2 w-full sm:w-auto">
          <div className="flex items-center gap-2 text-sm">
            ...
            <span className="font-medium">ETB {project.goalFund.toLocaleString()}</span>
          </div>
          <Button
            variant="outline"
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-3">
        ...
        <span className="text-sm text-gray-500">{project.postDuration} days left</span>
      </div>
      <div className="mb-4">
        <div className="flex items-center justify-between mb-1">
          <span className="text-sm font-medium">ETB {project.goalFund.toLocaleString()}</span>
          <span className="text-xs text-gray-500">{project.fundingProgress || 0}% funded</span>
        </div>
        <div className="h-1.5 w-full bg-gray-200 rounded-full">
          <div className="h-1.5 bg-orange-500 rounded-full" style={{ width: `${project.fundingProgress || 0}%` }}></div>
        </div>
      ...
      <div className="mt-auto">
        <Badge className={getSupportTypeColor(project.typeOfSupport)} className="mb-3">
