    ...
    <div className="min-h-screen pt-40 pb-16 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-2 mt-12">Share Your Feedback</h2>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-4">
              <label className="block text-sm font-medium">Share your experience in scaling</label>
              ...
              <Slider
                ...
                className="py-4 [&>span:first-child]:bg-orange-500 [&>span:last-child]:bg-orange-500 [&>span:last-child]:ring-orange-300"
              />
            ...
            <div className="flex justify-center pt-4">
              <Button
                type="submit"
                className="bg-orange-500 hover:bg-orange-600 text-white px-12 py-6 h-auto"
