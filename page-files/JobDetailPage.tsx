...
import { ArrowLeft, MapPin, Phone, Mail, Briefcase, FileText, Download, ExternalLink } from "lucide-react"
          ...
          >
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              <div className="flex flex-col items-center text-center mb-6">
                ...
                <div className="mt-2">
                  <span
                    className={`inline-flex items-center text-xs px-3 py-1 rounded-full ${getEmploymentTypeColor(candidate.typeOfEmployment)}`}
                  >
            ...
            <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
              <Tabs defaultValue="profile">
                ...
                <TabsContent value="profile" className="space-y-6">
                  <div>
                    <h2 className="text-xl font-bold mb-4">About {candidate.firstName}</h2>
                    <p className="text-gray-600">
                      {candidate.firstName} {candidate.lastName} is a professional in the field of {candidate.field}{" "}
                      with the {candidate.department} department. {candidate.firstName} is available for
                ...
                <TabsContent value="video">
                  <div className="space-y-6">
                    <h2 className="text-xl font-bold mb-4">Introduction Video</h2>
                ...
                <TabsContent value="documents">
                  <div className="space-y-6">
                    ...
                    <h2 className="text-xl font-bold mb-4">Identification Document</h2>
                    <div className="bg-gray-50 p-6 rounded-lg flex items-center justify-between">
                      <div className="flex items-center">
                        <FileText className="h-5 w-5 text-orange-500 mr-3" />
                        <span>Identification Document</span>
                    ...
                    <h2 className="text-xl font-bold mb-4">Education Certificates</h2>
                    <div className="space-y-4">
                      {candidate.educationCertificates.map((cert, index) => (
                        <div key={index} className="bg-gray-50 p-4 rounded-lg flex items-center justify-between">
                          <div className="flex items-center">
